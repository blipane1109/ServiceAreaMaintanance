...
public class Mailer {
	...
	public static void sendEmail(String zippedReport) throws IOException {
		...
		try {
			...
			message.setSubject("Service Area Maintanance Automation Execution Report");
			...
			textPart.setText("<html>" + " <body>" + "  <p style='font-family:Calibri;'>Hi Team,</p>"
					+ "<p style='font-family:Calibri;'> Please find below report for TestView, StepsView and PassPercentage of Today's SAM Automation execution. </p>" + "  <img src=\"cid:" + cid + "\"style='border:50 solid black'/>"

					+ "<p style='font-family:Calibri;'>For detailed execution report of the Service Area Maintanance, please find the attached  <b>" + extentReportName
					...
					+ "<p style='font-family:Calibri;'>Thanks and Regards,<br>SAM_Team</p>" + "<p><br></p>"

					+ "<p style='font-family:Calibri;'><font size='1'><center><<------------------------------------------------This is an automated email triggered from SAM Automation framework-------------------------------------------->></center></font></p>"
